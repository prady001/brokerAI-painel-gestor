...
export default function AgentStatusError({ error, reset }: AgentStatusErrorProps) {
  useEffect(() => {
    ...
    <main className="flex min-h-[40vh] flex-col items-center justify-center p-6">
      <div className="max-w-md rounded-lg border border-red-200 bg-red-50 p-6 text-center">
        <h2 className="text-lg font-semibold text-red-800">
          Erro ao carregar o status do agente
        </h2>
        <p className="mt-2 text-sm text-red-700">
          Não foi possível carregar as conversas ativas. Tente novamente.
        </p>
        <button
          type="button"
          onClick={reset}
